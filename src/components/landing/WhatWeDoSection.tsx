                ...
                <div className="grid grid-cols-2 gap-6 mb-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                      ...
                      <p className="text-sm text-gray-700 italic">"Dodaj agent za nekretnine koji predstavlja prostor"</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                      <p className="text-xs text-gray-500 mb-1">Prompt:</p>
                      <p className="text-sm text-gray-700 italic">"Dodaj klovna koji kuva ručak u kuhinji"</p>
                    </div>
                  </div>
                </div>
