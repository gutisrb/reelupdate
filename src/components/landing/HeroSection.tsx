            ...
            >
              ...
              <div className="space-y-6">
                ...
                <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold text-white leading-tight">
                  Pravi profesionalne video oglase za par minuta
                </h1>

                {/* Solution */}
                <p className="text-lg md:text-xl text-white/80 leading-relaxed">
                  Dodaj fotografije i osnovne info. Dobij 9:16 reel sa glasom, titlovima i muzikom. Automatski objavi na sve platforme odjednom.
                </p>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-blue-500/20 ring-1 ring-white/10">
                ...
                <div className="aspect-video bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center">
                  <div className="text-center space-y-4 p-8">
                    ...
                    <p className="text-white/60 text-sm">Demo video uskoro</p>
                  </div>
                </div>
