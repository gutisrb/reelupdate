...
export const API_ENDPOINTS = {
  ...
  google: {
    geminiVision: 'https://generativelanguage.googleapis.com/v1beta/models/gemini-3-flash:generateContent',
    geminiText: 'https://generativelanguage.googleapis.com/v1beta/models/gemini-3-flash:generateContent',
